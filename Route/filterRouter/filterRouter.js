...
const { filterAccount, filterPan, getAccount, filterAssetclass1, filterSubAsset, filterAllAssetClass, getAllSubAsset } = require("../../Contoller/filterController/filterController");
...
filterRouter.get("/api/asset-classes/:accountId", verifyToken, filterAllAssetClass)
